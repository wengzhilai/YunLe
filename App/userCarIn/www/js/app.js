...
angular.module('starter', ['ionic', 'starter.controllers', 'starter.services', 'config', 'filters', 'ngCordova', 'ngIOS9UIWebViewPatch', 'CoderYuan'])
    ...
    $ionicPlatform.ready(function () {
      ...
      if (navigator.userAgent.toLowerCase().indexOf('micromessenger') > -1) {
        ...
        if (openid == null && code == null && state == null) {
          ...
          toPost.Post("ClientLogin", postBean, function (currMsg) {
            if (currMsg.IsError) {
  ...
  .config(function ($stateProvider, $urlRouterProvider, $ionicConfigProvider) {
    ...
    //登录
      ...
      .state('editCar', {
        url: '/editCar/:id',
        templateUrl: 'templates/car/editCar.html',
        controller: 'editCarCtr'
      })
      .state('myCarList', {
        url: '/myCarList',
        cache: 'false',
        templateUrl: 'templates/car/myCarList.html',
        controller: 'myCarListCtr'
      })
      .state('toHelp', {
        url: '/toHelp/:id',
        templateUrl: 'templates/service/toHelp.html',
        controller: 'toHelpCtr'
      })
      .state('toInsure', {
        url: '/toInsure/:id',
        templateUrl: 'templates/insure/toInsure.html',
        controller: 'toInsureCtr'
      })
      //违章查询
      .state('queryVeh', {
        url: '/queryVeh',
        templateUrl: 'templates/service/queryVeh.html',
        controller: 'queryVehCtr'
      })
      .state('vehList', {
        url: '/vehList',
        templateUrl: 'templates/service/vehList.html',
        controller: 'vehListCtr'
      })
      ...
      .state('carInfo', {
        url: '/carInfo',
        templateUrl: 'templates/insure/carInfo.html',
        controller: 'carInfoCtr'
      })
      ...
      .state('followOrder', {
        url: '/followOrder/:id',
        templateUrl: 'templates/order/followOrder.html',
        controller: 'followOrderCtr'
      })
      .state('user', {
        url: '/user',
      ...
      .state('searchCar', {
        url: '/searchCar',
        templateUrl: 'templates/insure/searchCar.html',
        controller: 'searchCarCtr'
      })
      .state('helpOrderList', {
        url: '/helpOrderList',
        templateUrl: 'templates/help/helpOrderList.html',
        controller: 'helpOrderListCtr'
      })
      //维保列表
      .state('maintainOrderList', {
        url: '/maintainOrderList',
        cache: 'false',
        templateUrl: 'templates/maintain/maintainOrderList.html',
        controller: 'maintainOrderListCtr'
      })
      ...
      .state('editHelpOrder', {
        url: '/editHelpOrder',
        cache: 'false',
        templateUrl: 'templates/help/editHelpOrder.html',
      ...
      //维保表单
      .state('editMaintainOrder', {
        url: '/editMaintainOrder',
        cache: 'false',
        templateUrl: 'templates/maintain/editMaintainOrder.html',
        controller: 'editMaintainOrderCtr',
        params: {
          garage: null,
          location: null,
          bean: null,
      ...
      .state('followMaintainOrder', {
        ...
        templateUrl: 'templates/maintain/followMaintainOrder.html',
        controller: 'followMaintainOrderCtr'
      })

      .state('followHelpOrder', {
        url: '/followHelpOrder/:id',
        templateUrl: 'templates/help/followHelpOrder.html',
      ...
      .state('orderSingle', {
        url: '/orderSingle/:id',
        templateUrl: 'templates/order/orderSingle.html',
        controller: 'orderSingleCtr'
      })
      .state('editOrder', {
        url: '/editOrder/:type',
        templateUrl: 'templates/service/editOrder.html',
      ...
      .state('helpMap', {
        url: '/helpMap',
        cache: 'false',
        templateUrl: 'templates/help/helpMap.html',
        controller: 'helpMapCtr',
        params: {
          garage: null,
          id: 0
        }
      ...
      .state('maintainMap', {
        url: '/maintainMap',
        cache: 'false',
        templateUrl: 'templates/maintain/maintainMap.html',
        controller: 'maintainMapCtr',
        params: {
          garage: null,
          id: 0
        }
      ...
      .state('messageList', {
        url: '/messageList',
        templateUrl: 'templates/user/messageList.html',
        controller: 'messageListCtr'
      })
      .state('addressList', {
        url: '/addressList',
        cache: 'false',
        templateUrl: 'templates/address/addressList.html',
        controller: 'addressListCtr'
      })
      .state('addressSave', {
        url: '/addressSave/',
        templateUrl: 'templates/address/addressSave.html',
        controller: 'addressSaveCtr',
        params: {
          garage: null,
          location: null,
          url: null,
      ...
      .state('garageInfo', {
        url: '/garageInfo/',
        templateUrl: 'templates/garage/garageInfo.html',
        controller: 'garageInfoCtr',
        params: {
          id:null
        }
      })
