...
import {SalesmanListPage} from "../list/list";

@Component({
  selector: 'salesman-edit',
  templateUrl: 'edit.html',
  providers: [CommonService, ToPostService, FileUpService]
})
export class SalesmanEditPage implements OnInit {
  public user = AppGlobal.getUser()
  public userForm:FormGroup;
  public validationMessages:any;
  public formErrors = {};
  public bean:any = {AllCar: []};
  ...
  save() {
    ...
    this.toPostService.SaveOrUpdate("SalesmanClientAdd", postBean, (currMsg) => {
      if (!currMsg.IsError) {
        ...
        this.navCtrl.push(SalesmanListPage);
      }
      else {
        this.commonService.hint(currMsg.Message)
      }
