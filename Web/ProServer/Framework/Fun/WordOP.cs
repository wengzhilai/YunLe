...
//                string dir = Fun.AllWebPath("");//首先在类库添加using System.web的引用
...
//                //插入图片
//                if (File.Exists(Fun.AllWebPath("images//picture.jpg")))
//                {
//                    string FileName = Fun.AllWebPath("images//picture.jpg");//图片所在路径
...
//            Document WordDoc;
//            string strContent = "";
//            object strFileName = Fun.AllWebPath("test.doc ");
...
//        public static void HtmlToWord(string inputName, string outputName)
//        {
...
//                oWordDoc.SaveAs2(ref saveFileName, ref saveFormat, ref oMissing, ref  oMissing, ref oFalse, ref  oMissing, ref oMissing, ref oMissing, ref  oMissing, ref  oMissing, ref  oMissing, ref  oMissing, ref  oMissing, ref  oMissing, ref  oMissing, ref  oMissing);
