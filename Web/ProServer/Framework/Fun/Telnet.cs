    ...
    public class Telnet
    {
        ...
        public bool Connect()
        {
            ...
            try
            {
                ...
                wzlStr = "";
                //异步回调  
                s.BeginReceive(m_byBuff, 0, m_byBuff.Length, SocketFlags.None, new AsyncCallback(OnRecievedData), s);
        ...
        bool DispatchMessage(string strText)
        {
            try
            {
                //申请一个与字符串相当长度的char流        
                ...
                //IAsyncResult ar2 = s.BeginSend(smk, 0, smk.Length, SocketFlags.None,null,s);
        ...
        public bool WaitFor(string DataToWaitFor)
        {
            ...
            {
                if (strWorkingData.IndexOf("More") > 0)
                {
                    Send(" ");
                }
